...
export default props => <Box bg="#011C36" color="#fff"><Head><title>Meetups in Cities | the Hacker Zephyr</title><Container as="main" py={4}  variant="copy" sx={{ minHeight: '100vh', color:"#fff!important"}} {...props} /></Box>
...
Feel free to join in for the full day in San Francisco (up till 8:30PM PST). Meet us at GitHub corporate office at 10 AM PST! You’re also open to join other office tours (contact us for details) and dinner in BCA City Hall Park at 6PM PST.    
